...
stateful component are used to update data and it's only responsible to for that piece of dat itself and functional components take any sort of data and display information

2. When does a componentWillMount function be called? What about a componentWillUpdate?
   componentWillMount gets called before mounting happens and componentWilUpdate get called before the render

3. Define stateful logic.
   stateful logic is a code that creates or alters state

4. What are the three step of creating a successful test? What is done in each phase?
   the first step in creating a test is to arrange, in this step we render out component. The next step is act, we locate what we are testing and save it in a variable. Lastly we test it against something, ex: to be int the document etc
